<nav class="flex-1 space-y-1 px-2 py-4">
    <a  href="{{ route('dashboard') }}" wire:navigate class="bg-gray-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
    ...
    <a href="{{ route('clients.index') }}" wire:navigate class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
